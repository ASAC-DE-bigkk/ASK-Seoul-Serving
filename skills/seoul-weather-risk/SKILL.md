...
description: Use when a user asks for weather-risk time windows in a named Seoul administrative dong and the answer must come from ASK Seoul's published weather_place_risk_window product.
license: MIT
metadata:

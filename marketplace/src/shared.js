...
//    두 번 손대게 된다 — vars 로 뺄지는 다음에 단계 개념이 또 늘어날 때 다시 본다.
//    1 = 명시적 거부만 차단 (실측 2026-08-05: prod 에 거부 0종 → 아무것도 안 막는다)
//    2 = 증거 누락도 차단 (fail-closed) — 2026-08-07 전환. 전제였던 백필이 끝났다:
//        공개 57종 전부 d1_catalog_sources 에 allowed_with_attribution 증거 보유(실측).
//        즉 전환 시점 기준 새로 막히는 제품은 0종이고, 이후 **증거 없이 새 제품을
//        공개하면 서빙이 닫힌다** — 그게 이 단계의 존재 이유다(#88).
export const RIGHTS_GATE_STAGE = 2;
